...
<script type="module">
  ...
  document.getElementById("toggleSettingBar").addEventListener("click",toggleWidth);
  document.getElementById("toggleSettingBar1").addEventListener("click",toggleWidth);
  // Generate table
